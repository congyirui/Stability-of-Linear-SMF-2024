function [V,nr] = con2vert_backup(A,b)
...
%     [c, fval, exitflag, output] = linprog(zeros(1, n), A, b, [], [], [], [], [], options);
%     if exitflag == -2
%         error('Unable to locate a point within the interior of a feasible region.')
%     elseif exitflag == -4
%         error('NaN value was encountered during execution of the algorithm.')
%     end
end
b = b - A*c;
